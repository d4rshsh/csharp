...
namespace Sep14
{
    ...
    public class Searching
    {
        ...
        {
            movies.Add(new Movie("Sita Ramam", "Tamil", "Romance", 20));
            movies.Add(new Movie("Vikram", "Tamil", "Thriller", 40));
            movies.Add(new Movie("Thiruchitramblam", "Tamil", "Drama", 50));
            movies.Add(new Movie("Ae Dil Hai Mushkil", "Hindi", "Drama", 60));
            movies.Add(new Movie("The Godfather", "English", "Gangster", 34));
        }
        public void search()
        {
    ...
    public class CustomerUser : Searching
    {
        ...
        {
            if (Id == 7358952929 && Password == "sesh2002")
            {
                login = "true";
                return true;
            }
