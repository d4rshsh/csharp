...
namespace DataAccessLib
{
    public class Employee_DAL
    {
        ...
        /// Empid is identity field, so no insertion
        /// </summary>
        /// <param name="employee"></param>
        public bool InsertEmployee(Employee_BAL employee)
        {
            SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["NWCString"].ConnectionString);

            SqlCommand cmdInsert = new SqlCommand("Insert Into employees(lastname, firstname, title, birthdate) values(@lastname," +
                "@firstname,@title, @birthdate)", cn);
        ...
        {
            SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["NWCtring"].ConnectionString);
