...
namespace Sept26
{
    class Program
    {
        ...
        private static void WithOutParameter(EmployeeHelper helper, Employee_BAL emp)
        {
            Console.WriteLine("Enter Employeeid ");
            emp.EmployeeID = Convert.ToInt32(Console.ReadLine());
        ...
        private static void WithoutOutParameter(EmployeeHelper helper, Employee_BAL emp)
        {
            Console.WriteLine("Enter Employeeid ");
            emp.EmployeeID = Convert.ToInt32(Console.ReadLine());
            Employee_BAL bal = new Employee_BAL();
