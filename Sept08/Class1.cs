...
namespace ClassLibrary1
{
    public class Class1
    {
        ...
        public class Employee // PS 2
        {
            ...
            {
                Console.WriteLine("Enter the name of the manager who's  employees you want to see ");
                ...
                {
                    Console.WriteLine("No employees work under this manager");
                }
            }
